...
> Background-Slider is a website built with HTML, SCSS, and TypeScript. We use linters to overcome code errors and maintain clean code. Please check out the live demo.
...
- [Live Demo Link](https://ameer2000mzori.github.io/Background-Slider/src/)
